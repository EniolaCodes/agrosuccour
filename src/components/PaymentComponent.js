...
const PaymentComponent = ({ orderId, amount, email }) => {
  ...
  return (
    ...
    //   Pay Now
    // </button>
    <button onClick={handlePayment} className=" bg-Green500 text-white rounded-[8px] p-[10px] text-center text-[16px] md:text-[18px] font-bold w-full md:w-[190px]  h-[48px] hover:bg-Green600 transition">
      Pay Now
    </button>
  );
};
